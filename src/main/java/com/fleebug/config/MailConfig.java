...
public class MailConfig {
    ...
    // Env.get("AZURE_COMMUNICATION_COREROUTER_STRING");
    ...
    static {
        ...
        if (endpoint == null || endpoint.isEmpty() || accessKey == null || accessKey.isEmpty()) {
            throw new IllegalStateException(
                    "Azure Communication Service endpoint or access key is not set in environment variables.");
        }
        ...
        /*
         * This is an alternative way to initialize the EmailClient using connection
         * string,
         * but we are using endpoint and credential for better security practices.
         */

        // emailClient = new
        // EmailClientBuilder().connectionString(connectionString).buildClient();
